...
let racers=[{"id":1,"driver_name":"Racer 1","top_speed":650,"acceleration":8,"handling":7},{"id":2,"driver_name":"Racer 2","top_speed":600,"acceleration":9,"handling":9},{"id":3,"driver_name":"Racer 3","top_speed":500,"acceleration":10,"handling":6},{"id":4,"driver_name":"Racer 4","top_speed":550,"acceleration":7,"handling":8},{"id":5,"driver_name":"Racer 5","top_speed":700,"acceleration":5,"handling":4}
]

app.get("/api/cars",(req,res)=>{
    return res.send(JSON.stringify(racers));
})
...
app.post("/api/races", (req, res) => {
    let track = tracksList.filter((track) => track.id === req.body.track_id);
    ...
    return res.send(JSON.stringify(race));
});
...
app.get("/api/races/:id", (req, res) => {
    ...
    return res.send(JSON.stringify(raceInfo));
});
...
app.post("/api/races/:id/start", (req, res) => {
    ...
    let race = races.filter((race) => race.id === raceId);
